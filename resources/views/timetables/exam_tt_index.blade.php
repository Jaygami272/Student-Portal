...
<div class="pagetitle">
    <div class="row">
        <div class="col-sm-6">
            <h1>Mid-Exam Time table</h1>
        </div>
        <div class="col-sm-6">
            <a href="{{route('timetables.ecreate')}}"><button type="button" class="btn btn-gray float-right">Add Timetable</button></a>
...
<div class="container">
    <div class="image-container">
       ...
       <div>
        ...
        <form method="POST" action="{{ route('timetables.edestroy',$ltimetable->id) }}">
            @method('DELETE')
            @csrf
