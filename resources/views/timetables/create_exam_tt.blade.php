...
<section class="section">
    ...
    <form method="POST" enctype="multipart/form-data" action="{{ route('timetables.estore') }}">
      @csrf
    ...
    <br>
      <div class="">
        ...
        <a href="{{route('timetables.eindex')}}"><button type="button" class="btn btn-secondary">Back</button></a>
      </div>
